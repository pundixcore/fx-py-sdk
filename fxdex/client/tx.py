...
from fxdex.client.query import QueryClient
...
from cosmos.auth.v1beta1.query_pb2_grpc import QueryStub
from cosmos.base.v1beta1.coin_pb2 import Coin
from cosmos.tx.signing.v1beta1.signing_pb2 import SIGN_MODE_DIRECT
from cosmos.tx.v1beta1.tx_pb2 import Fee
from fxdex.cosmos import DirectSignModeHandler, Transaction
from fxdex.cosmos._wallet import Wallet
...
class TransactionClient(RpcChannel):
    ...
    def __init__(
        ...
        Args:
          tendermint34Client: A Tendermint34Client instance to make calls against fxdex tendermint rpc.
