...
from fx_py_sdk.codec.fx.dex.v1 import tx_pb2 as fx_dot_dex_dot_v1_dot_tx__pb2
...
class MsgStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReduceMargin = channel.unary_unary(
                '/fx.dex.v1.Msg/ReduceMargin',
                request_serializer=fx_dot_dex_dot_v1_dot_tx__pb2.MsgReduceMargin.SerializeToString,
                response_deserializer=fx_dot_dex_dot_v1_dot_tx__pb2.ReduceMarginResp.FromString,
                )
...
def add_MsgServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReduceMargin': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=fx_dot_dex_dot_v1_dot_tx__pb2.MsgReduceMargin.FromString,
                    response_serializer=fx_dot_dex_dot_v1_dot_tx__pb2.ReduceMarginResp.SerializeToString,
            ),
...
class Msg(object):
    ...
    def ReduceMargin(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fx.dex.v1.Msg/ReduceMargin',
            fx_dot_dex_dot_v1_dot_tx__pb2.MsgReduceMargin.SerializeToString,
            fx_dot_dex_dot_v1_dot_tx__pb2.ReduceMarginResp.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
