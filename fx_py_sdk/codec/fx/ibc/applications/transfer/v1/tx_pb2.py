...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='fx/ibc/applications/transfer/v1/tx.proto',
...
_MSGTRANSFER = _descriptor.Descriptor(
  name='MsgTransfer',
  full_name='fx.ibc.applications.transfer.v1.MsgTransfer',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='source_port', full_name='fx.ibc.applications.transfer.v1.MsgTransfer.source_port', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='source_channel', full_name='fx.ibc.applications.transfer.v1.MsgTransfer.source_channel', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='token', full_name='fx.ibc.applications.transfer.v1.MsgTransfer.token', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='sender', full_name='fx.ibc.applications.transfer.v1.MsgTransfer.sender', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='receiver', full_name='fx.ibc.applications.transfer.v1.MsgTransfer.receiver', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timeout_height', full_name='fx.ibc.applications.transfer.v1.MsgTransfer.timeout_height', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='timeout_timestamp', full_name='fx.ibc.applications.transfer.v1.MsgTransfer.timeout_timestamp', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='router', full_name='fx.ibc.applications.transfer.v1.MsgTransfer.router', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fee', full_name='fx.ibc.applications.transfer.v1.MsgTransfer.fee', index=8,
...
_MSGTRANSFERRESPONSE = _descriptor.Descriptor(
  ...
  full_name='fx.ibc.applications.transfer.v1.MsgTransferResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_MSGTRANSFER.fields_by_name['fee'].message_type = cosmos_dot_base_dot_v1beta1_dot_coin__pb2._COIN
...
_MSG = _descriptor.ServiceDescriptor(
  name='Msg',
  full_name='fx.ibc.applications.transfer.v1.Msg',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Transfer',
    full_name='fx.ibc.applications.transfer.v1.Msg.Transfer',
    index=0,
