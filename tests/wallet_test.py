...
class MyTestCase(unittest.TestCase):
    ...
    def test_public_key(self):
        ...
        self.assertEqual(pub_key.to_address(), 'fx12fv300avzf266qp930ur4g50agajuz6jcsj5tz')
    ...
    def test_private_key_sign(self):
        priv_key_bytes = bytes.fromhex('47788d676b3d841f4d608e552a9ed5756e8e54f3cb054aade5c454f6fb3be6ef')
